...
This example implements a resynthesis effect for Daisy Patch SM, initially inspired by the Resynthesis.hpp code from the All Electric Smart Grid project but I think since moved into a more granular direction, just based on iterating on the output sounds. This is maybe 90% GPT, 10% human, so buyer beware if you fork this or use this code.
